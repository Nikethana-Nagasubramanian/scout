  ...
  return (
    <div className="page profile-page">
      <PageHeader title="Search profile" description="What Scout matches jobs against and the only facts it may use when tailoring a resume.">
        <button className="button" type="submit" form="profile-form">Save and rescore jobs</button>
      </PageHeader>
      ...
      <div className="profile-layout">
        <form id="profile-form" action={saveProfileAction} className="profile-form">
          <ProfileSection label="01" title="Identity and summary" description="Every newly generated resume starts from these fields.">
          ...
          <ProfileSection label="02" title="Search preferences" description="Scout scores and filters every fetched job against these. One entry per line.">
            <div className="field"><label htmlFor="target_titles">Target roles</label><textarea id="target_titles" name="target_titles" defaultValue={targetTitles.join("\n")} /></div>
          ...
          <ProfileSection label="03" title="Resume and links" description="Existing tailored resumes stay unchanged when you edit the base resume.">
            <div className="field full"><label htmlFor="base_resume_text">Full base resume</label><textarea id="base_resume_text" name="base_resume_text" rows={16} defaultValue={profile.base_resume_text} /></div>
          ...
          <div className="profile-form-actions"><button className="button" type="submit">Save and rescore jobs</button></div>
        </form>
